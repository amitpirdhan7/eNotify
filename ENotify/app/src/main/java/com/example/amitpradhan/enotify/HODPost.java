...
public class HODPost extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_hodpost);
        ...
        button9=(Button)findViewById(R.id.prof);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_hodpost, menu);
        return true;
    }
