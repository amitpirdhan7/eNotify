...
public class MultiSelectGallery extends GalleryActivity implements View.OnClickListener {
    private int maxPhotoSelectionAllowed = 5;
    ...
    @Override
    protected void onPhotoClick(View v, String imagePath, boolean isSelected,
                                Cursor c) {
    ...
    protected FolderGalleryItemViewManager getFolderGalleryItemViewManager() {
        return new FolderGalleryItemViewManager() {
            ...
            public void bindView(View view, Context context, Cursor c,
                                 String folderName, String thumbnailPath,
                                 int folderIdColumnIndex, int imageCountColumnIndex) {
                FolderViewHolder holder = (FolderViewHolder) view.getTag();
                holder.thumbnail.setImageResource(R.drawable.ic_launcher);
                holder.thumbnail.setTag(thumbnailPath);
                mImageLoader.displayImage("file://" + thumbnailPath,
                        holder.thumbnail, mDisplayImageOptions);
                holder.totalImageCount.setText("("
                        + c.getString(imageCountColumnIndex) + ")");
                ...
                if (filesCount > 0) {
                    ...
                    holder.selectedImageCount
                            .setBackgroundResource(filesCount < 5 ? R.drawable.ic_notification
    ...
    protected PhotoGalleryItemViewManager getPhotoGalleryItemViewManager() {
        return new PhotoGalleryItemViewManager() {
            ...
            public void bindView(View view, Context context, Cursor c,
                                 ...
                                 int folderIdColumnIndex, int folderNameColumnIndex,
                                 int imageNameColumnIndex) {
            ...
            public View newView(Context context, Cursor cursor,
                                ViewGroup viewGroup) {
                View convertView = mLayoutInflater.inflate(
                        R.layout.gallery_image_view, null);
 ...
 /*   public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_multi_select_gallery, menu);
        return true;
    }
